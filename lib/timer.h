...
static inline int tm_active(struct timer * t)
{
	return t->expires != 0;
}

static inline bird_clock_t tm_remains(struct timer * t)
{
	return t->expires ? t->expires - now : 0;
}

static inline void tm_start_max(struct timer * t, unsigned after)
{
