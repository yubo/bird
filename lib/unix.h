...
static inline ip_addr ipa_from_in6(__attribute__ ((__unused__)) struct in6_addr a)
...
#else
/* Temporary dummy */
static inline struct in6_addr ipa_to_in6(__attribute__ ((__unused__)) ip_addr a)
